...
public class VelocityView extends AbstractTemplateView {
    ...
    private VelocityProperties velocityProperty;
    ...
    protected void initApplicationContext(ApplicationContext context) {
        ...
        if (this.velocityProperty == null) {
            velocityProperty = BeanFactoryUtils.beanOfTypeIncludingAncestors(obtainApplicationContext(),
                    VelocityProperties.class, true, false);
        }
    }
    ...
    protected VelocityEngine autodetectVelocityEngine() throws BeansException {
        try {
            return BeanFactoryUtils.beanOfTypeIncludingAncestors(obtainApplicationContext(),
                    VelocityEngine.class, true, false);
    ...
    private void doRender(Context context, HttpServletResponse response) throws Exception {
        ...
        if (layoutUrlToUse != null) {
            ...
            String layoutUrl = VelocityProperties.DEFAULT_LAYOUT;
            if (velocityProperty != null && StringUtils.hasLength(velocityProperty.getLayoutUrl())) {
